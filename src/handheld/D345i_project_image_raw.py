...
class DepthToPointCloudConverter:
    def __init__(self):
        ...
        self.pointcloud_pub = rospy.Publisher('/camera/depth/reproject', PointCloud2, queue_size=10)

        self.pointcloud_pub_sonar = rospy.Publisher('/dragonfly26/tof/reproject_sonar', PointCloud2, queue_size=10)

        # Publisher for Image
        self.image_pub = rospy.Publisher('/camera/depth/reproject_alter', Image, queue_size=1)
