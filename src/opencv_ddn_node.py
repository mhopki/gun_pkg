...
def image_callback(ros_image):
    ...
    try:
        ...
        frame = ros_numpy.image.image_to_numpy(ros_image)
    ...
    output_msg = ros_numpy.image.numpy_to_image(img, encoding="bgr8")
...
if __name__ == '__main__':
    ...
    # Load class names.
    classesFile = rospy.get_param('~classes_file', "/home/root/kumarRobotics/autonomy_ws/src/gun_pkg/src/coco.names")
    modelWeights = rospy.get_param('~model_weights', "/home/root/kumarRobotics/autonomy_ws/src/gun_pkg/src/best.onnx")
    ...
    image_sub = rospy.Subscriber('/depth_gray_image', Image, image_callback, queue_size=1)
